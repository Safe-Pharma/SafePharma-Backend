...
namespace SafePharma.DAL.Migrations
{
    ...
    [Migration("20260821010336_AddArabicAndEnglishNotificationFields")]
    partial class AddArabicAndEnglishNotificationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SafePharma.DAL.CustomerMedicineHistory", b =>
                {
                    ...
                    b.ToTable("CustomerMedicineHistories");
                });

            modelBuilder.Entity("SafePharma.DAL.CustomerOrganFunction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("OrganImpairmentLevelId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrganImpairmentLevelId");

                    b.HasIndex("CustomerId", "OrganId")
                        .IsUnique();

                    b.ToTable("CustomerOrganFunctions", (string)null);
                });

            modelBuilder.Entity("SafePharma.DAL.CustomerPharmacyBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CustomerId", "PharmacyId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SafePharma.DAL.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PharmacyId", "Type", "ReferenceId")
                        .IsUnique()
            ...
            modelBuilder.Entity("SafePharma.DAL.Organ", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SafePharma.DAL.OrganImpairmentLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SafePharma.DAL.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("AmountPaidByCard")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AmountPaidByCash")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SafePharma.DAL.SaleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SafePharma.DAL.CustomerOrganFunction", b =>
                {
                    b.HasOne("SafePharma.DAL.Customer", "Customer")
                        .WithMany("CustomerOrganFunctions")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SafePharma.DAL.Organ", "Organ")
                        .WithMany("CustomerOrganFunctions")
                        .HasForeignKey("OrganId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SafePharma.DAL.OrganImpairmentLevel", "OrganImpairmentLevel")
                        .WithMany("CustomerOrganFunctions")
                        .HasForeignKey("OrganImpairmentLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("OrganImpairmentLevel");
                });

            modelBuilder.Entity("SafePharma.DAL.CustomerPharmacyBalance", b =>
                {
                    b.HasOne("SafePharma.DAL.Customer", "Customer")
                        .WithMany("PharmacyBalances")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SafePharma.DAL.Sale", b =>
                {
                    b.HasOne("SafePharma.DAL.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SafePharma.DAL.SaleItem", b =>
                {
                    b.HasOne("SafePharma.DAL.Batch", "Batch")
                        .WithMany()
                    ...
                    b.HasOne("SafePharma.DAL.Sale", "Sale")
                        .WithMany("SaleItems")
            ...
            modelBuilder.Entity("SafePharma.DAL.Customer", b =>
                {
                    ...
                    b.Navigation("CustomerOrganFunctions");
