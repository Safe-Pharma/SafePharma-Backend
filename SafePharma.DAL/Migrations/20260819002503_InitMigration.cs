...
namespace SafePharma.DAL.Migrations
{
    ...
    public partial class InitMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CustomerRelative",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RelativeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HasAccessToRelative = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerRelative", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerRelative_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerRelative_Customers_RelativeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerPharmacyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicines_Pharmacies_OwnerPharmacyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerMedicineHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerMedicineHistories_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerMedicineHistories_Medicines_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PharmacyMedicineTaxes", x => new { x.PharmacyMedicineId, x.TaxId });
                    table.ForeignKey(
                        name: "FK_PharmacyMedicineTaxes_PharmacyMedicines_PharmacyMedicineId",
                        column: x => x.PharmacyMedicineId,
                        principalTable: "PharmacyMedicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PharmacyMedicineTaxes_Taxes_TaxId",
                        column: x => x.TaxId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerRelative_CustomerId_RelativeId",
                table: "CustomerRelative",
                columns: new[] { "CustomerId", "RelativeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CustomerRelative_RelativeId",
                table: "CustomerRelative",
                column: "RelativeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicine_Owner_TradeNameEn_Local",
                table: "Medicines",
                columns: new[] { "OwnerPharmacyId", "TradeNameEn" },
                unique: true,
                filter: "[IsGlobal] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_Medicine_TradeNameEn_Global",
                table: "Medicines",
                column: "TradeNameEn",
                unique: true,
                filter: "[IsGlobal] = 1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PharmacyMedicine_Pharmacy_SKU",
                table: "PharmacyMedicines",
                columns: new[] { "PharmacyId", "SKU" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PharmacyMedicineTaxes_TaxId",
                table: "PharmacyMedicineTaxes",
                column: "TaxId");
